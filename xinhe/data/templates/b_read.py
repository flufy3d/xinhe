...
POOL = TemplatePool("B", [
    ...
    # self_name (问"我叫什么")
    Template(user_text="我叫什么名字?",
             asst_text="你叫{value}。",
             register=RegisterStyle.CASUAL,
             meta={"relation": "self_name"}),
    Template(user_text="还记得我叫啥不?",
             asst_text="记得,你叫{value}。",
             register=RegisterStyle.ORAL,
             meta={"relation": "self_name"}),
    Template(user_text="请再确认一下我的姓名。",
             asst_text="您的姓名是{value}。",
             register=RegisterStyle.FORMAL,
             meta={"relation": "self_name"}),
    Template(user_text="我之前告诉你我叫什么来着?",
             asst_text="你说你叫{value}。",
             register=RegisterStyle.CASUAL,
             meta={"relation": "self_name"}),
    Template(user_text="我名字?",
             asst_text="{value}。",
             register=RegisterStyle.TERSE,
             meta={"relation": "self_name"}),
